...
export default function Home() {
  return (
    <div>
      <HelmetComponent
        title="Welcome to our Restaurant - Best Food Delivered to Your Door"
        description="Experience the best food delivery service with a variety of dishes to choose from. Order now and enjoy!"
        keywords="restaurant, food delivery, best food, order online, delicious food"
        ogTitle="Welcome to our Restaurant - Best Food Delivered to Your Door"
        ogDescription="Order from our wide selection of delicious food items and get them delivered to your door!"
        ogUrl="https://foods-1.onrender.com/"
        ogImage="https://foods-1.onrender.com/assets/food-banner.jpg"
        ogImageAlt="Food Delivery Banner"
        ogImageWidth="1200"
        ogImageHeight="630"
      />
      <Baner />
