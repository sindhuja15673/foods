...
//         ogUrl="https://foods-1.onrender.com/cart"
//         ogImage="https://foods-1.onrender.com/assets/burger.jpg"
...
const Cart = () => {
  ...
  const getOgImageUrl = (itemName) => {
    // Check if the item name has a corresponding image in the imageMap
    const matchingImage = imageMap[itemName];
    return matchingImage || 'https://default-image.com'; // Or a placeholder image
  };
  ...
  return (
    <div className='cart-page'>
      <HelmetComponent
        ...
        ogDescription="Review and manage your cart items before proceeding to checkout."
        ogUrl="https://foods-1.onrender.com/cart"
        // Use the getOgImageUrl function to dynamically set the ogImage
        ogImage={cart.length > 0 ? getOgImageUrl(cart[0].name) : ''} 
        ogImageAlt="Product in Cart"
        ogImageWidth="300"
        ogImageHeight="200"
      />
