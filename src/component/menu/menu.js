...
export default function Menu() {
  ...
  const title = "Our Menu - Best Food Delivered to Your Door";
  const description = "Explore our delicious food menu, including vegetarian, non-vegetarian, and snacks. Order your favorite meals now!";
  const imageUrl = "https://foods-1.onrender.com/assets/burger.jpg";
  const url = "https://foods-1.onrender.com/menu";
